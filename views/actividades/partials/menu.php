<nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?= URL ?>actividades">Actividades</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link <?= in_array($_SESSION['id_rol'],$GLOBALS['actividad']['new'])? 'active':'disabled' ?>" aria-current="page" href="actividades/nuevo">Nuevo</a>
                    </li>
